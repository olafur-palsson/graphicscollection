...
const start = () => {
  ...
  for (let i = 0; i < nTriangles; i++) {
    ...
    triangles.push(0, 0, 0, red, blue, green)
    triangles.push(Math.sin(angle1), 0, Math.cos(angle1), red, blue, green)
    triangles.push(Math.sin(angle2), 0, Math.cos(angle2), red, blue, green)
  }
